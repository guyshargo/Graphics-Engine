...
int main() {
    ...
    while (isRunning) {
        ...
        std::string currentExerciseName = std::string(magic_enum::enum_name(static_cast<ExerciseEnum>(selectedExercise)));
        
        if (ImGui::BeginCombo("Exercise", currentExerciseName.c_str())) {
            
            // Loop automatically through all enum values generated by magic_enum
            for (const auto& val : magic_enum::enum_values<ExerciseEnum>()) {
